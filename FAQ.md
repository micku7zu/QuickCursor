...
In **Android 16+** **real time gestures** are supported but are for **PRO users only**: 
...
**There are also some prerecorded** gestures available that can be dispatched instantly (PRO only).
